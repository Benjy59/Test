...
public class Calculette implements Icalculette{
	...
	public Integer division(Integer nombre1, Integer nombre2) {
		if (nombre1 == null || nombre2 ==null){
			throw new RuntimeException("impossible de faire une division si au moins un nombre est null");
		}
			else if (nombre2 == 0) {
				throw new RuntimeException("Impossible de faire une division si le 2eme nombre est = a 2");
			}
		return nombre1 / nombre2;
